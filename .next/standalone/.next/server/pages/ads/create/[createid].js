...
/* harmony import */ var _components_helpers_loadStaticFile__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4831);
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                        children: "Моля изберете категория в която искате да публикувате"
                    })
                ]
            }),
            data.items.map((item)=>/*#__PURE__*/ (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(_components_ads_CatButton__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {
                    ...item,
                    key: item.slug,
...
const getServerSideProps = async ({ query  })=>{
    ...
    const adsData = await (0,_components_helpers_loadStaticFile__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z)("adsData");
    const data = adsData.find((x)=>x.slug === createid);
    return {
        props: {
            data
        }
...
var __webpack_exports__ = __webpack_require__.X(0, [210,676,664,62,60], () => (__webpack_exec__(1141)));
