...
export declare type AdUpdateFormInputValues = {
    title?: string;
    type?: string;
    cat?: string;
    condition?: string;
...
export declare type AdUpdateFormValidationValues = {
...
export declare type AdUpdateFormOverridesProps = {
    AdUpdateFormGrid?: FormProps<GridProps>;
...
export declare type AdUpdateFormProps = React.PropsWithChildren<{
    overrides?: AdUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    ad?: Ad;
    onSubmit?: (fields: AdUpdateFormInputValues) => AdUpdateFormInputValues;
    onSuccess?: (fields: AdUpdateFormInputValues) => void;
    onError?: (fields: AdUpdateFormInputValues, errorMessage: string) => void;
    onCancel?: () => void;
    onChange?: (fields: AdUpdateFormInputValues) => AdUpdateFormInputValues;
    onValidate?: AdUpdateFormValidationValues;
} & React.CSSProperties>;
export default function AdUpdateForm(props: AdUpdateFormProps): React.ReactElement;
