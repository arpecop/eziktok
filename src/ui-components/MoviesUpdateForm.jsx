...
export default function MoviesUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = { ...initialValues, ...moviesRecord };
  ...
  const [moviesRecord, setMoviesRecord] = React.useState(movies);
  React.useEffect(() => {
    const queryData = async () => {
      const record = id ? await DataStore.query(Movies, id) : movies;
